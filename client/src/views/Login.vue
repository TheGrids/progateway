                ...
                <div class="login__block__wrap">
                    ...
                    <div class="login__block-content">
                        <div class="input__wrap">
                            ...
                            <input class="input" type="email" name="" id="" placeholder="Введите почту">
                        </div>
                        <div class="input__wrap">
                            <div class="input__icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <input class="input" type="password" name="" id="" placeholder="Введите пароль">
                        </div>
                    </div>
                    <div class="login__block-footer">
                        ...
                        <button class="btn white">Авторизоваться</button>
                    </div>
                </div>
            </div>
        </div>

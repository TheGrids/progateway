                ...
                <form @submit.prevent="submit" class="login__block__wrap">
                    ...
                    <div class="login__block-content">
                        <div class="input__wrap">
                            ...
                            <input class="input" type="text" name="" id="name" v-model="this.name" placeholder="Введите ваше имя" required>
                        </div>
                        <div class="input__wrap">
                            <div class="input__icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <input class="input" type="text" name="" id="surname" v-model="this.surname" placeholder="Введите вашу фамилию" required>
                        </div>
                        <div class="input__wrap">
                            <div class="input__icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <input class="input" type="email" name="email" id="email" v-model="this.email" placeholder="Введите вашу почту" required>
                        </div>
                        <div class="input__wrap">
                            <div class="input__icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <input class="input" type="password" name="pass" v-model="this.password" id="pass" placeholder="Введите пароль" required>
                        </div>
                        <div class="input__wrap">
                            <div class="input__icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <input class="input" type="password" name="" v-model="this.confirm_password" id="passs" placeholder="Введите пароль еще раз" required>
                        </div>
                    </div>
                    <div class="login__block-footer">
                        <div class="footer-dop">Есть аккаунт? <router-link to="/login">Войти</router-link></div>
                        <button class="btn white" type="submit">Зарегистрироваться</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    methods: {
        submit() {
            if(this.password !== this.confirm_password) {
                this.$notify({
                    title: "Ошибка",
                    text: "Укажите одинаковые пароли",
                    type: "error"
                });
            } else {
                userService.userRegistration(this.name, this.surname, this.email, this.password).then(res => {
                    this.$notify({
                        title: "Успешно",
                        text: res.data.msg,
                        type: "success"
